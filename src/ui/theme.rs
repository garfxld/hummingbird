...
impl Default for Theme {
    fn default() -> Self {
        // Jellybeans (Zed theme by Raj Kashyap / jellybeans-vim extension) palette.
        Self {
            window_background: WindowBackgroundAppearance::Opaque,

            frame_background: rgb(0x0C0C0C),
            background_primary: rgb(0x101010), // 0x151515
            background_secondary: rgb(0x101010), // 0x151515
            background_tertiary: rgb(0x1C1C1C),

            border_color: rgb(0x403C41),
            inner_border_color: rgb(0x403C41),

            album_art_background: rgb(0x262626),

            text: rgb(0xE8E8D3),
            text_secondary: rgb(0x888888),
            text_disabled: rgb(0x605958),
            text_link: rgb(0x8FBFDC),

            nav_button_hover: rgb(0x1E1E1E),
            nav_button_hover_border: rgb(0x262626),
            nav_button_active: rgb(0x101010),
            nav_button_active_border: rgb(0x181818),
            nav_button_pressed: rgb(0x202020),
            nav_button_pressed_border: rgb(0x2A2A2A),

            playback_button: rgba(0x00000000),
            playback_button_hover: rgb(0x404040),
            playback_button_active: rgb(0x0D0D0D),
            playback_button_border: rgba(0x00000000),
            playback_button_toggled: rgb(0x8FBFDC),
            playback_button_repeat_one: rgb(0x99AD6A),
            stop_after_current_indicator: rgb(0xFAD07A),

            window_button: rgba(0x00000000),
            window_button_hover: rgb(0x333333),
            window_button_active: rgb(0x1C1C1C),

            list_item: rgba(0x00000000),
            list_item_alternate: rgb(0x141414),
            list_item_hover: rgb(0x1E1E1E),
            list_item_active: rgb(0x141414),
            list_item_current: rgb(0x1E1E1E),
            list_item_selected: rgb(0x1E2731),

            close_button: rgba(0x00000000),
            close_button_hover: rgb(0x6B2B22),
            close_button_active: rgb(0x4A1E18),

            button_primary: rgb(0x3E6E8A),
            button_primary_border: rgb(0x5C8CA6),
            button_primary_hover: rgb(0x4A7E9C),
            button_primary_border_hover: rgb(0x6C9CB6),
            button_primary_active: rgb(0x2E5468),
            button_primary_border_active: rgb(0x466E80),
            button_primary_text: rgb(0xE3F1FA),

            button_secondary: rgb(0x1C1C1C),
            button_secondary_border: rgb(0x403C41),
            button_secondary_hover: rgb(0x404040),
            button_secondary_border_hover: rgb(0x524B53),
            button_secondary_active: rgb(0x131313),
            button_secondary_border_active: rgb(0x302C30),
            button_secondary_text: rgb(0xE8E8D3),

            button_warning: rgb(0x7A5A20),
            button_warning_border: rgb(0xA9822F),
            button_warning_hover: rgb(0x8A6828),
            button_warning_border_hover: rgb(0xBA9040),
            button_warning_active: rgb(0x4A3814),
            button_warning_border_active: rgb(0x654A1C),
            button_warning_text: rgb(0xF5E9C8),

            button_danger: rgb(0x5A1F16),
            button_danger_border: rgb(0x7A2C1F),
            button_danger_hover: rgb(0x6B241A),
            button_danger_border_hover: rgb(0x8A3324),
            button_danger_active: rgb(0x3D1610),
            button_danger_border_active: rgb(0x562015),
            button_danger_text: rgb(0xF2E0DC),

            slider_foreground: rgb(0x4A7E9C),
            slider_background: rgb(0x2A2A2A),

            eq_grid_line: rgb(0x403C41),
            eq_grid_line_zero: rgb(0x555050),
            eq_curve: rgb(0x8FBFDC),
            eq_curve_fill: rgba(0x8FBFDC2E),
            eq_band_curve: rgb(0xB3D7EA),
            eq_dot: rgb(0x888888),
            eq_dot_selected: rgb(0x8FBFDC),
            eq_dot_disabled: rgb(0x605958),
            eq_spectrum_pre: rgba(0x8888881A),
            eq_spectrum_post: rgba(0x8FBFDC24),
            eq_spectrum_edge: rgba(0x8FBFDC99),

            elevated_background: rgb(0x1C1C1C),
            elevated_border_color: rgb(0x403C41),

            menu_item: rgba(0x00000000),
            menu_item_hover: rgb(0x262626),
            menu_item_border_hover: rgb(0x403C41),
            menu_item_active: rgb(0x141414),
            menu_item_border_active: rgb(0x202020),

            modal_overlay_bg: rgba(0x00000055),

            text_input_selection: rgba(0x8FBFDC88),
            caret_color: rgb(0xE8E8D3),
            text_highlight_background: rgba(0x8FBFDC66),

            palette_item_hover: rgb(0x262626),
            palette_item_border_hover: rgb(0x403C41),
            palette_item_active: rgb(0x141414),
            palette_item_border_active: rgb(0x202020),

            scrollbar_background: rgb(0x1C1C1C),
            scrollbar_foreground: rgba(0xE8E8D34C),

            textbox_background: rgb(0x1C1C1C),
            textbox_border: rgb(0x403C41),

            checkbox_background: rgb(0x1C1C1C),
            checkbox_background_hover: rgb(0x404040),
            checkbox_background_active: rgb(0x141414),
            checkbox_border: rgb(0x403C41),
            checkbox_border_hover: rgb(0x524B53),
            checkbox_border_active: rgb(0x302C30),
            checkbox_checked: rgb(0xE8E8D3),
            checkbox_checked_bg: rgb(0x8FBFDC),
            checkbox_checked_bg_hover: rgb(0x9FCFE8),
            checkbox_checked_bg_active: rgb(0x6A9CB8),
            checkbox_checked_border: rgb(0xA8D0E8),
            checkbox_checked_border_hover: rgb(0xB0D8F0),
            checkbox_checked_border_active: rgb(0x7AACC8),

            callout_background: rgba(0xFAD07A1F),
            callout_border: rgba(0xFAD07A55),
            callout_text: rgb(0xE8E8D3),

            liked_song: rgb(0xCF6A4C),

            status_success: rgb(0x99AD6A),
            status_error: rgb(0xCF6A4C),
            status_disabled: rgb(0x605958),

            toast_info_background: rgb(0x1C1C1C),
            toast_info_border: rgb(0x403C41),
            toast_info_text: rgb(0xE8E8D3),
            toast_info_track: rgb(0x888888),

            toast_warning_background: rgb(0x572E10),
            toast_warning_border: rgb(0x754916),
            toast_warning_text: rgb(0xF5ECD9),
            toast_warning_track: rgb(0xFFB964),

            toast_success_background: rgb(0x322B11),
            toast_success_border: rgb(0x4A4516),
            toast_success_text: rgb(0xE8F0DF),
            toast_success_track: rgb(0x99AD6A),

            toast_error_background: rgb(0x590A0F),
            toast_error_border: rgb(0x771617),
            toast_error_text: rgb(0xF2E8E8),
            toast_error_track: rgb(0xCF6A4C),
        }
    }
}
